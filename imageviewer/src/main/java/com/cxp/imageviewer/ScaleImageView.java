...
public class ScaleImageView extends ImageView implements OnGlobalLayoutListener,
    ...
    private OnSingleTapListener ll;
    private int mWidth;
    private int mHeight;
    ...
    public void setOnSingleTapListener(OnSingleTapListener ll) {
        this.ll = ll;
    }
    ...
    public void onGlobalLayout() {
        if (!mOnce) {
            ...
            // 缩小值
            if (dw > mWidth && dh > mHeight) {
                scale = Math.min(mWidth * 1.0f / dw, mHeight * 1.0f / dh);
            }
            ...
            mScaleMatrix.postScale(mInitScale, mInitScale, mWidth / 2,
                    mHeight / 2);
            setImageMatrix(mScaleMatrix);
            mOnce = true;
        }
