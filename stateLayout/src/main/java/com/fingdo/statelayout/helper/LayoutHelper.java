...
//            int loadingImg = a.getResourceId(R.styleable.StateLayout_loadingImg,-1);
     ...
     * @return 空数据View
     */
    public static View getEmptyView(LayoutInflater layoutInflater, EmptyItem item, final StateLayout stateLayout) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (stateLayout.getRefreshLListener() != null) {
